...
module.exports = {
  data: new SlashCommandBuilder()
    .setName("page")
    .setDescription("Provides you with a link to this server's page on Universe Servers."),
  async execute(interaction) {
    ...
    const embed = new EmbedBuilder()
      ...
      .setDescription("Click on the button below to go to this server's page on Universe Servers.")
      .setFooter({
